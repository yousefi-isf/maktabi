...
const APP_ERROR_MESSAGES = {
	...
	GRADE_LEVEL_TITLE_EXISTS: "A grade level with this title already exists",
	GRADE_LEVEL_NOT_FOUND: "The grade level was not found",
	GRADE_LEVEL_IN_USE: "The grade level cannot be deleted because it is in use",
